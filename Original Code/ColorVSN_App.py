...
def main():
    # Open video file
    input_video_path = 'D:/Downloads/Past Lands/ColorVSN/ColorVSN/Original Code/input_video.mp4'
    ...
    out = cv2.VideoWriter('ouput-1-output.mp4', codec, fps, (width, height))
    ...
    processed_clip = VideoFileClip(out)
